INSERT INTO inventory.product_category (name)
VALUES ('Laptop'),
       ('Phone'),
       ('Tablet');

INSERT INTO inventory.product (name, price, description, category_id)
...
INSERT INTO inventory.product_property (name,
                                        description,
                                        product_id)
VALUES ('Color',
...
INSERT INTO inventory.inventory_item (quantity,
                                      product_id)
VALUES (100, (select id from inventory.product where name = 'Apple MacBook Air (M2)')),
       (100, (select id from inventory.product where name = 'MacBook Pro (14-inch and 16-inch)')),
       (100, (select id from inventory.product where name = 'HP Spectre x360 14')),
       (100, (select id from inventory.product where name = 'Samsung Galaxy S23 Ultra')),
       (100, (select id from inventory.product where name = 'iPhone 14 Pro Max')),
       (100, (select id from inventory.product where name = 'iPhone 14 Pro')),
       (100, (select id from inventory.product where name = 'Apple iPad Air (2022)')),
       (100, (select id from inventory.product where name = 'iPad 2022 (10th gen)')),
       (100, (select id from inventory.product where name = 'Samsung Galaxy Tab S8'));